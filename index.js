...
console.log("Starting Autodiscover Email Settings...");
...
router.get("/email.mobileconfig", function *mobileconfig() {
...
console.log("Started Autodiscover Email Settings: ", settings);
